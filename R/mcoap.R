...
#' Fit the multi-study covariate-augmented linear factor regression model via variational inference
#' @description Fit the multi-study covariate-augmented overdispersed Poisson factor model via variational inference
